...
def load_smplx(gender='female', template='assets/models/SMPLX_{}.fbx'):
    ...
    bpy.ops.import_scene.fbx(
        filepath=filepath, axis_forward='Y', axis_up='Z', global_scale=100)
    # filepath = "/home/diazbarros/Projects/SynthSL/SynthSL/VIBE/output/03October_2010_Sunday_tagesschau-5767/meshes/0001/000000.obj"
    # bpy.ops.import_scene.obj(
    #     filepath=filepath, axis_forward='Y', axis_up='Z')
