...
from body_render import getextures
...
def get_bodytexture_paths(
        texture_types,
        split='train',
        body_textures_folder='assets/textures/bodywithands',
        meshcapade_textures_folder='assets/textures/meshcapade/body_textures/smpl/MC_texture_skintones/',
        shapenet_split_folder='assets/textures/shapenet',
        shapenet_folder='/sequoia/data2/dataset/shapenet/ShapeNetCore.v2',
        lsun_path='/sequoia/data2/gvarol/datasets/LSUN/data/img',
        imagenet_path='/sequoia/data3/datasets/imagenet',
    ...
    if 'bodywithands' in texture_types:
        textures.extend(getextures.get_all_textures_bodywithands(folder=body_textures_folder, split=split, gender=gender))
    if 'meshcapade' in texture_types:
        textures.extend(getextures.get_meshcapade_textures(folder=meshcapade_textures_folder, gender=gender))
...
def get_clothing_texture_paths(textures_clothing='assets/textures/textures_clothing/smplx_textures_clothing_2048_20220905a',
                               gender='neutral'):
    return getextures.get_meshcapade_clothing(folder=textures_clothing, gender=gender)
